...
let up = `❤️‍🩹🇱🇰 *_Queen Chooty Nelumi Md Connected Successfully!_* ✅ 
...
if (config.AUTO_BIO === 'true'){
               await
conn.updateProfileStatus(`𝙌𝙐𝙀𝙀𝙉 𝘾𝙃𝙊𝙊𝙏𝙔 𝙉𝙀𝙇𝙐𝙈𝙄 𝙈𝘿 ☠️❤️‍🩹  🇱🇰 ѕяι ℓαηкα вσт 🇱🇰 𝗦𝘂𝗰𝗰𝗲𝘀𝗳𝘂𝗹𝗹𝘆 𝗖𝗼𝗻𝗻𝗲𝗰𝘁𝗲𝗱➤ 𝗧𝗵𝗶𝘀 𝗗𝗲𝘃𝗶𝗰𝗲 𝗜𝘁 𝗛𝗮𝘃𝗲 𝗕𝗲𝗲𝗻 𝗥𝘂𝗻𝗻𝗶𝗻𝗴 𝗙𝗼𝗿 😇💻`)
}
